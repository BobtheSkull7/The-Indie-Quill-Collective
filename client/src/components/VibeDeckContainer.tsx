          ...
          return (
            <div key={curriculum.id} className="rounded-xl border border-purple-200 bg-white shadow-sm overflow-hidden">
              <button
                ...
                className="w-full flex items-center gap-2 sm:gap-4 px-3 sm:px-5 py-3 sm:py-4 hover:bg-purple-50/50 transition-colors"
              >
              ...
              {isCurriculumExpanded && (
                <div className="px-2 sm:px-5 pb-3 sm:pb-5 border-t border-purple-100 bg-gradient-to-b from-purple-50/30 to-white">
                        ...
                        return (
                          <div key={deck.id} className="rounded-lg border border-gray-200 bg-white shadow-sm overflow-hidden">
                            <button
                              ...
                              className="w-full flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-2 sm:py-3 hover:bg-gray-50 transition-colors"
                            >
                              {isDeckExpanded ? (
                            ...
                            {isDeckExpanded && (
                              <div className="px-2 sm:px-4 pb-3 sm:pb-4 pt-1 border-t border-gray-100 bg-gradient-to-b from-gray-50/50 to-white">
                                {deck.tomes.length === 0 ? (
                                  <div className="text-center py-6 text-gray-400 text-sm">
                                        ...
                                        <div key={tome.id} className="rounded-lg border border-amber-200/60 bg-gradient-to-b from-amber-50/30 to-white overflow-hidden">
                                          <div className="flex items-center gap-2 sm:gap-3 px-2 sm:px-4 py-2 sm:py-3">
                                            ...
                                            >
                                              ...
                                              <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center flex-shrink-0 ${tome.absorbed ? "bg-green-100" : "bg-amber-100"}`}>
                                                {locked ? (
                                              ...
                                              <div className="flex-1 min-w-0 text-left">
                                                <h5 className="font-semibold text-slate-800 text-sm truncate">{tome.title}</h5>
                                                <p className="text-xs text-gray-500 truncate">
                                                  {locked ? <span className="hidden sm:inline">Read &amp; complete to unlock tasks</span> : `${tome.cards.length} ${tome.cards.length === 1 ? 'task' : 'tasks'}`}
                                                  {locked && <span className="sm:hidden">Locked</span>}
                                                </p>
                                              </div>
                                            </button>
                                            <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
                                              ...
                                              <button
                                                ...
                                                className={`flex items-center gap-1 text-xs px-2 sm:px-3 py-1.5 rounded-full border transition-colors ${
                                                  locked
                                              ...
                                              >
                                                <BookOpen className="w-3 h-3" />
                                                <span className="hidden sm:inline">{locked ? "Read Lesson" : "Re-read"}</span>
                                              </button>
                                            </div>
                                          </div>

                                          {isTomeExpanded && (
                                            <div className="px-2 sm:px-4 pb-3 sm:pb-4 pt-1 border-t border-amber-100">
                                              {locked ? (
