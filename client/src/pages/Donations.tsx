...
const DONATION_TIERS = [
  {
    ...
    name: "Micro-Donation",
    range: "$1 - $25",
    description: "Every dollar combines with other donors to help an emerging author reach the finish line.",
    icon: Gift,
    color: "teal",
    defaultAmount: 10,
    minAmount: 1,
  ...
  },
  {
    ...
    name: "Supporter",
    range: "$26 - $100",
    description: "Your contribution joins others to cover editing, ISBN, or copyright fees for an author.",
    icon: Star,
    color: "blue",
    defaultAmount: 50,
    minAmount: 26,
  ...
  },
  {
    ...
    name: "Champion",
    range: "$101 - $599",
    description: "Team up with fellow donors to fund cover design, editing, or marketing for an author.",
    icon: Users,
    color: "purple",
    defaultAmount: 250,
    minAmount: 101,
