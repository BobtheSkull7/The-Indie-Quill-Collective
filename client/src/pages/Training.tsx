  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="font-display text-3xl font-bold text-slate-800 flex items-center gap-3">
            <GraduationCap className="w-8 h-8 text-teal-600" />
            Training Dashboard
          </h1>
          <p className="text-gray-600 mt-1">
            120-Hour Curriculum Overview • Indie Quill Impact Engine
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Goal: 20 students × 120 hours = 2,400 hours
              </p>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="bg-amber-50 rounded-lg p-4">
              <p className="text-sm text-amber-800">
                ...
                Students progress from basic literacy to published authors while improving reading comprehension.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="bg-indigo-50 rounded-lg p-4">
              <p className="text-sm text-indigo-800">
                ...
                Students learn manuscript development, editing, and navigate the full publishing process.
              </p>
            </div>
          </div>
        </div>
