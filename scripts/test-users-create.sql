...
INSERT INTO applications (user_id, pen_name, date_of_birth, is_minor, status, persona_type, why_collective, goals, hear_about_us, has_story_to_tell)
...
INSERT INTO applications (user_id, pen_name, date_of_birth, is_minor, status, persona_type, why_collective, goals, hear_about_us, has_story_to_tell, guardian_name, guardian_email, guardian_phone, guardian_relationship)
...
-- Verify insertion
SELECT u.id, u.email, u.first_name, u.last_name, a.pen_name, a.persona_type, a.is_minor
FROM users u
